...
#' 
#' @param mesh A  MESH2D object representing the triangular mesh. This can be created with  \code{\link{create.MESH.2D}}.
...
#' 
#' @param FEMbasis A FEMbasis object representing the basis; See \code{\link{create.FEM.basis}}.
...
#' @param FEMbasis An FEMbasis object representing the Finite Element basis; See \link{create.FEM.basis}.
...
#' @param FEM A FEM object to be evaluated
#' @return 
